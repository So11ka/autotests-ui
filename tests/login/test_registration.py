...
class TestRegistration:
    def test_successful_registration(self, chromium_page: Page):
        ...
        registration_username_input = chromium_page.get_by_test_id('registration-form-email-input').locator('input')
